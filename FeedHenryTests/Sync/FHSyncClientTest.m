...
// TODO How to inject cloudProps
//- (void)testSyncClientListCollision {
//    // given
//    id fhMock = OCMClassMock([FH class]);
//
//    OCMStub([fhMock performCloudRequest:@"myShoppingList" method:@"POST" headers:nil args:@{@"fn" : @"listCollisions"} completionHandler:[OCMArg any]]);
//    // when
//    [_syncClient manageWithDataId:@"myShoppingList" AndConfig:_config AndQuery:_query AndMetaData:_customMetaData];
...
//    }];
//    // then
//    OCMVerify([fhMock performCloudRequest:@"myShoppingList" method:@"POST" headers:nil args:@{@"fn" : @"listCollisions"} completionHandler:[OCMArg any]]);
//}

//- (void)testSyncClientRemoveCollision {
//    // given
//    id fhMock = OCMClassMock([FH class]);
//    OCMStub(([fhMock performCloudRequest:@"myShoppingList" method:@"POST" headers:nil args:@{@"fn" : @"removeCollisions", @"hash" : @"1111"} completionHandler:[OCMArg any]]));
//    // when
//    [_syncClient manageWithDataId:@"myShoppingList" AndConfig:_config AndQuery:_query AndMetaData:_customMetaData];
...
//    }];
//    // then
//    OCMVerify(([fhMock performCloudRequest:@"myShoppingList" method:@"POST" headers:nil args:@{@"fn" : @"removeCollisions", @"hash" : @"1111"} completionHandler:[OCMArg any]]));
//}
